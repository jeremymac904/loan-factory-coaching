...
export const aiAdvantageModules: AiAdvantageModule[] = [
  {
    ...
    doThisToday: [
      "Create your AI Twin using the Loan Factory approved method.",
    ...
    outcomes: [
      ...
      "Build a working AI Twin using the Loan Factory method.",
    ...
    topics: [
      ...
      "AI Twin setup using the Loan Factory method",
    ...
    assignment: [
      "Build your AI Twin using the Loan Factory approved method.",
